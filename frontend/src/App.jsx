...
export default function App() {
  ...
  const LoginView = () => (
    <div style={styles.card}>
      ...
      <input type="password" placeholder="รหัสผ่าน" style={styles.input} />
  ...
  const RegisterView = () => (
    <div style={styles.card}>
      ...
      <div style={styles.row}>
        <input type="text" placeholder="ชื่อ" style={styles.input} />
        <input type="text" placeholder="นามสกุล" style={styles.input} />
      </div>
      <input type="email" placeholder="อีเมล" style={styles.input} />
      <input type="tel" placeholder="เบอร์โทรศัพท์" style={styles.input} />
      <div style={styles.row}>
        <input type="password" placeholder="รหัสผ่าน" style={styles.input} />
        <input type="password" placeholder="ยืนยันรหัสผ่าน" style={styles.input} />
      </div>
      
      <div style={{ textAlign: 'center', fontSize: '12px', marginBottom: '15px' }}>
        <label><input type="checkbox" /> ฉันยอมรับเงื่อนไขและข้อตกลงการใช้งาน</label>
      </div>

      <button style={styles.buttonPrimary}>สมัครสมาชิก</button>
